...
DynQconAPChange = @scenario DynQconAPLevelChange begin
    s1 = 0.5
    s2 = 0.5
    @init begin
        P = 1.0
...
DynQoldAPLevelChange = @scenario DynQconAPLevelChange begin
    s1 = 0.5
    s2 = 0.5
    @init begin
        AP = [1.0, 1.0]
...
DynQoldAPChange = @scenario DynQconAPLevelChange begin
    s1 = 0.5
    s2 = 0.5
    @init begin
        AP = [1.0, 1.0]
...
DynQconAPLevelChange2 = @scenario DynQconAPLevelChange begin
    s1 = 0.5
    s2 = 0.9
    gₐ = 0.003
    @init begin
...
DynQodlAPLevelChange2 = @scenario DynQconAPLevelChange begin
    s1 = 0.5
    s2 = 0.2
    s3 = 0.2
    gₐ = 0.003
