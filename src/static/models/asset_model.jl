...
AssetModel = @model begin
  ...
  @parameters begin
    ...
    s0 = 0.836089551258839, "nominal speculative debt at zero interest and reference asset price"
    s1 = 4.0, "interest sensitivity of speculative debt"
